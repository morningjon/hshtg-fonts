...
4. Enter the following URL:
   ```
   https://raw.githubusercontent.com/morningjon/standardnotes-ivory-theme/main/theme.json
   ```
5. Click **Install**
...
5. Select the `theme.json` file

### Method 3: Local Development

1. Clone this repository:
   ```bash
   git clone https://github.com/morningjon/standardnotes-ivory-theme.git
   cd standardnotes-ivory-theme
   ```
...
- **theme.json** - Theme metadata and configuration for Standard Notes
